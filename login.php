...
if($email || $pass){
  ...
  }else if($row && $pass != $row['pass']){
    echo '<script>alert("wrong password!!!!!");</script>';
  }else if(!$row){
    echo '<script>alert("the email id has no account!!!!!");</script>';
  }
      ...
      <center>
        ...
        <form action="login.php" method="POST">
          <table>
            ...
            <tr>
              <td><input class="input" type="text" placeholder="Email" name="email"/></td>
            </tr>
            <tr>
              <td>
